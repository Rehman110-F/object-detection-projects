...
A real-time face mask detection system built with YOLO that detects 
and classifies three states — **mask on**, **no mask**, and 
**partial mask** — directly from a live camera feed.
